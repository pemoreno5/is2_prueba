...
def funcion_skin(skin):
    ...
    if skin == 'DEFAULT':
        ...
        model.imagen1 = pygame.image.load("GOKU00.png")
        model.imagen2 = pygame.image.load("GOKU01.png")
        model.imagen3 = pygame.image.load("GOKU02.png")
        model.imagen4 = pygame.image.load("GOKU03.png")
        model.imagen5 = pygame.image.load("GOKU04.png")
        model.imagen6 = pygame.image.load("GOKU05.png")
        model.imagen7 = pygame.image.load("GOKU06.png")
        model.imagen8 = pygame.image.load("GOKU07.png")
        model.imagen9 = pygame.image.load("GOKU08.png")
        model.imagen10 = pygame.image.load("GOKU09.png")
        model.imagen11 = pygame.image.load("GOKU10.png")
        model.imagen12 = pygame.image.load("GOKU11.png")
        game.ChasquiRunner()

    elif skin == 'HULK':
        print("Inicializado con cambios cambios {}".format(skin))
        model.imagen1 = pygame.image.load("HULK00.png")
        model.imagen2 = pygame.image.load("HULK01.png")
        model.imagen3 = pygame.image.load("HULK02.png")
        model.imagen4 = pygame.image.load("HULK03.png")
        model.imagen5 = pygame.image.load("HULK04.png")
        model.imagen6 = pygame.image.load("HULK05.png")
        model.imagen7 = pygame.image.load("HULK06.png")
        model.imagen8 = pygame.image.load("HULK07.png")
        model.imagen9 = pygame.image.load("HULK08.png")
        model.imagen10 = pygame.image.load("HULK09.png")
        model.imagen11 = pygame.image.load("HULK10.png")
        model.imagen12 = pygame.image.load("HULK11.png")
        game.ChasquiRunner()
    else:
...
def shield():
    ...
    texto = fuente.render('Shield Activated', True, (255,255,255))
    texto_rect = texto.get_rect()
    texto_rect = [(ancho / 2) - 300, alto / 2]
    ventana.blit(texto, texto_rect)
    pygame.display.flip()
...
def speed():
    ...
    fuente = pygame.font.SysFont('Consolas', 36)
    texto = fuente.render('Speed++', True, (255,255,255))
    texto_rect = texto.get_rect()
    texto_rect = [(ancho / 2) - 300, alto / 2]
    ventana.blit(texto, texto_rect)
    pygame.display.flip()
...
class CRunner():
    ...
    def ChasquiRunner(self):
        ...
        while True:
            ...
            if pygame.sprite.collide_rect(self.powerup1, self.jugador):
                shield()
            if pygame.sprite.collide_rect(self.powerup2, self.jugador):
                self.__speed()
    ...
    def __speed(self):
        # En esta función se va a dar un powerup, en este caso un rayo al jugador cuando haya hecho collide
        self.fuente = pygame.font.SysFont('Consolas', 36)
        self.texto = self.fuente.render('Speed++', True, (255,255,255))
        self.texto_rect = self.texto.get_rect()
        self.texto_rect = [(ancho / 2) - 300, alto / 2]
        self.ventana.blit(self.texto, self.texto_rect)
        pygame.display.flip()
        self.jugador.velocidad = 20
       # pygame.sprite.spritecollide(self.powerup2,self.jugador,True)
...
class PowerUp1(pygame.sprite.Group):
    def __init__(self, posy, posx):
...
class PowerUp2(pygame.sprite.Group):
    def __init__(self, posy, posx):
        pygame.sprite.Group.__init__(self)
...
class GameMenu():
    def menu_del_juego(self):
        ...
        self.menu_jugar.add_selector('Escoger Skin', [('Default', 'DEFAULT'),
                                                     ('Goku', 'GOKU'),
                                                     ('Hulk', 'HULK')],
                                onreturn = False,
